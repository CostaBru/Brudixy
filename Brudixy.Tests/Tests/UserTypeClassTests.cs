...
{
    [TestFixture]
    public class UserTypeClassTests
    {
        public UserTypeClassTests()
        {
            DataTable.RegisterUserTypeStringMethods((UserClass t) => SerializeHelper.SerializeWithDcs(t), (s) => SerializeHelper.DeserializeWithDcs<UserClass>(s));
        }
        ...
        public void TestTuple()
        {
            ...
            var dataRow = dataTable.GetRowBySinglePk(new UserClass(1, 1));
        ...
        public void TestTupleJson()
        {
            ...
            var dataRow = jCopy.GetRowBySinglePk(new UserClass(1, 1));
        ...
        public void TestTupleXml()
        {
            ...
            var dataRow = xCopy.GetRowBySinglePk(new UserClass(1, 1));
        ...
        public void TestTupleMerge()
        {
            ...
            var dataRow = copy.GetRowBySinglePk(new UserClass(1, 1));
        ...
        public void TestTupleMissingKey()
        {
            ...
            var dataRow = dataTable.GetRowBySinglePk(new UserClass(0, 0));
        ...
        private static DataTable CreateTupleTable()
        {
            ...
            dataTable.AddColumn("id", typeof(UserClass));
