...
namespace Brudixy.Interfaces.Generators
{
    ...
    public static class BuiltinSupportStorageTypes
    {
	    public static List<StorageType> StorageTypes = new ()
	    {
		    ...
		    new("Boolean", true, false ,"System.Boolean", "bool") { Default = "false", FromStr = "return XmlConvert.ToBoolean(value.ToLower());", ToStr = "return XmlConvert.ToString(value);", RangeSupport = false } ,
		    ...
		    new("Int32", true, false ,"System.Int32", "int") { Default = "int.MinValue", FromStr = "return Tool.IntParseFast(value, 0, true);", ToStr = "return value.ToString(Tool.mNumberinfo ?? Tool.GetNumberFormat());", AutoIncrementSupport = true },
		    ...
		    new("Decimal", true, false ,"System.Decimal", "decimal") { Default = "decimal.MinValue", FromStr = "return Decimal.Parse(value, Tool.mNumberinfo ?? Tool.GetNumberFormat());", AutoIncrementSupport = true, ToStr = "return Tool.DecimalToString(value, string.Empty);"},
	    ...
	    public static readonly Dictionary<string, string> KnownTypesToGenClassName = StorageTypes.Where(s => string.IsNullOrEmpty(s.ShortAlias) == false).ToDictionary(s => s.EnumName, s => s.GenClassName, StringComparer.OrdinalIgnoreCase);
